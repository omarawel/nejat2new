...
const content = {
    de: {
        ...
        infoText: "Diese Funktion befindet sich derzeit in der Entwicklung. Bald kannst du hier dein Vermögen (Bargeld, Gold, Silber, Investitionen etc.) eingeben, und der Rechner ermittelt automatisch den fälligen Zakat-Betrag basierend auf dem aktuellen Nisab-Wert.",
    ...
    en: {
        ...
        infoText: "This feature is currently under development. Soon you will be able to enter your assets (cash, gold, silver, investments, etc.) here, and the calculator will automatically determine the due Zakat amount based on the current Nisab value.",
        ...
        <div className="w-full max-w-md">
            ...
            <Card className="text-center">
                ...
                <CardContent className="space-y-4">
                    ...
                    <Button disabled>{c.calculate}</Button>
                </CardContent>
            </Card>
        </div>
    </div>
